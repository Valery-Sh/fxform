...
public class PaintUtil {
    public static Polygon createDownTriangle() {
    ...
    public static Polygon createUpTriangle() {
        Polygon polygon = new Polygon();
        polygon.getPoints().addAll(new Double[]{
            0.0, 0.0,
            7.0, 0.0,
    ...
    public static TextFormatter createTextFormatter(final TextField txtField, double minValue, double maxValue, int scale) {
        ...
        TextFormatter<Double> f = new TextFormatter(PaintUtil.doubleStringConverter(scale), minValue, filter);
