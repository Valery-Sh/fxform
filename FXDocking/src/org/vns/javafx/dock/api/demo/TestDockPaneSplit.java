...
/*        dn3_1.getContext().setDividerPos(0.608);                
        
        dn1.getContext().setDividerPos(0.346);                
        dn2.getContext().setDividerPos(0.713);                
        dn3.getContext().setDividerPos(0.608);                
*/        
...
/*        dnc1.getContext().setDividerPos(0.346);                
        dnc2.getContext().setDividerPos(0.713);                
        dnc3.getContext().setDividerPos(0.608);                
*/        
        dnc1.setId("dnc1");
        dnc2.setId("dnc2");
        dnc3.setId("dnc3");
