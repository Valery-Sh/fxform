 ...
 * @author Valery
 */
public class TestStackPaneContext1 extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        custom.setMaxHeight(100);
        custom.setMaxWidth(100);
        StackPane.setAlignment(custom, Pos.BOTTOM_LEFT);        
        custom.setId("custom");
        DockNode custom1 = new DockNode();
        custom1.setTitle("CUSTOM 1");
        custom1.setMaxHeight(100);
        custom1.setMaxWidth(100);
        
        primaryRoot.getChildren().add(custom1);
        StackPane.setAlignment(custom1, Pos.BOTTOM_RIGHT);
